...
License:	NCSA
URL:		http://llvm.org
Source0:	http://llvm.org/releases/%{version}/clang-%{version}.src.tar.xz
...
%exclude %{_datarootdir}/clang/bash-autocomplete.sh
...
%changelog
* Fri Aug 18 2017 Dongsu Park <dongsu@kinvolk.io> - 6.0.0-1
- clang 6.0.0
